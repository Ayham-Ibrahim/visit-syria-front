...
const Explorer = () => {
    ...
    return (
        ...
        <PageLayout img={img} options1={cities} onClickBtn={handleSearch} setFirstSelect={handleSelect1} setSecondSelect={handleSelect2} setValue={(e) => setSearch(e.target.value)} select1={select1} select2={select2}>
